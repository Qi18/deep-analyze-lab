...
本轮已完成部署和结果核验：3 项通过、1 项部分通过、1 项失败。详细失败轨迹见 [实验报告](results/report.md)，不将五个样例当作正式准确率。
...
HF_ENDPOINT=https://hf-mirror.com HF_HUB_DISABLE_XET=1 \
  /data/venvs/tesla-vllm-085/bin/python labs/phase-01-deployment/scripts/phase1_download.py

# 默认打印命令；确认端口和 GPU 0 空闲后执行
/data/venvs/deepanalyze-phase1/bin/python labs/phase-01-deployment/scripts/phase1_services.py
/data/venvs/deepanalyze-phase1/bin/python labs/phase-01-deployment/scripts/phase1_services.py --execute

curl -fsS http://127.0.0.1:8000/v1/models
curl -fsS http://127.0.0.1:8200/health

/data/venvs/deepanalyze-phase1/bin/python labs/phase-01-deployment/scripts/phase1_smoke.py --execute
```
...
```bash
/data/venvs/deepanalyze-phase1/bin/python labs/phase-01-deployment/scripts/phase1_verify.py
```
...
状态和实测结果见 [results/report.md](results/report.md)。
